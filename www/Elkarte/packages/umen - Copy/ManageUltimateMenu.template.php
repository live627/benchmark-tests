...
function template_main()
{
	...
	echo '
		...
		<form action="', $scripturl, '?action=admin;area=umen;sa=savebutton" method="post" accept-charset="UTF-8"  class="roundframe">';
	...
	echo '
			<dl class="settings">
				...
				<dd>
					<input type="text" name="name" value="', $context['button_data']['name'], '" tabindex="1" class="input_text" style="width: 100%;" />
				</dd>
				<dt>
				...
				<dd>
					<select name="position" size="10" style="width:22%;">
						<option value="after"', $context['button_data']['position'] === 'after' ? ' selected="selected"' : '', '>' . $txt['um_menu_after'] . '...</option>
						<option value="child_of"', $context['button_data']['position'] === 'child_of' ? ' selected="selected"' : '', '>' . $txt['um_menu_child_of'] . '...</option>
						<option value="before"', $context['button_data']['position'] === 'before' ? ' selected="selected"' : '', '>' . $txt['um_menu_before'] . '...</option>
					</select>
	...
	echo '
						<input type="checkbox" class="input_check" onclick="invertAll(this, this.form, \'permissions[]\');" id="check_group_all"', $context['button_data']['all_permissions'] ? ' checked="checked"' : '', ' />
